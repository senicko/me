...
description: Exploring possible use of OpenAI's tts model for generating automatic "podcasts" for blog posts. I looked into why would anyone want to do that and how I made it.
tags:
  - ai
  - podcast
  - cli
