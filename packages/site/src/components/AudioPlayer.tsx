...
export default function AudioPlayer({ src }: { src: string }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col items-end gap-4 rounded-md bg-zinc-900 p-4 text-sm text-white sm:flex-row dark:border-zinc-900 dark:bg-zinc-100 dark:text-zinc-900">
        <audio
          ref={audioRef}
          src={src}
        ...
        <div className="flex w-full items-center justify-end gap-4 sm:w-auto sm:justify-normal">
          <input
            ref={seekBarRef}
            value={volume}
            onChange={handleVolumeChange}
            className={cn(styles.slider, "w-full sm:w-20")}
            style={{
